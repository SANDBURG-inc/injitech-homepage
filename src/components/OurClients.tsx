...
const LogoCard = ({ src }: { src: string }) => (
    <div className="flex-shrink-0 w-[357px] h-[152px] bg-white rounded-[4px] flex items-center justify-center overflow-hidden">
...
export default function OurClients() {
    ...
    return (
        <section className="w-full bg-white flex flex-col items-center overflow-hidden">
            <div className="w-full max-w-[1400px] flex flex-col pt-[80px] lg:pt-[160px] pb-[40px] lg:pb-[72px] px-5 lg:px-0">
                {/* Header Content */}
                <ScrollReveal>
            ...
            <ScrollReveal className="w-full">
                <div className="relative w-full pb-[80px] lg:pb-[160px]">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="ml-[-150px]"> {/* Offset second row for visual variety */}
