        ...
        <section className="relative w-full h-screen overflow-hidden flex items-center justify-center bg-black">
            ...
            <div className="relative z-10 w-full max-w-[1400px] px-5 sm:px-10 flex flex-col items-center text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto opacity-0 animate-fade-in-up animation-delay-400">
                    <button className="h-12 lg:h-16 px-6 lg:px-8 bg-primary rounded-lg flex items-center justify-center gap-3 group hover:bg-primary/90 hover:scale-[1.02] transition-all active:scale-[0.98] cursor-pointer w-full sm:w-auto">
                    ...
                    <button className="h-12 lg:h-16 px-6 lg:px-8 bg-white border border-primary rounded-lg flex items-center justify-center gap-3 group hover:bg-white/90 hover:scale-[1.02] transition-all active:scale-[0.98] cursor-pointer w-full sm:w-auto">
